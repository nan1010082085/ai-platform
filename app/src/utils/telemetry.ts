...
export const AI_TELEMETRY_EVENTS = {
  ...
  WORKFLOW_IMPORT: 'ai.workflow.import',
  WORKFLOW_EXPORT: 'ai.workflow.export',
  WORKFLOW_DEBUG_RUN: 'ai.workflow.debug_run',
  WORKFLOW_DEBUG_STOP: 'ai.workflow.debug_stop',
  WORKFLOW_AUTO_SWITCH: 'ai.workflow.auto_switch',
